...
public class EmployeeManagerTest {
    ...
    @ParameterizedTest
    @ValueSource(doubles = {40000, 50000, 60000, 70000})
    public void testIsSalaryValidForPosition(double salary) {
        ...
        //seniorDeveloper
        if(salary >= seniorDeveloper.getMinSalary() && salary <= seniorDeveloper.getMaxSalary()) {
            assertTrue(employeeManager.isSalaryValidForPosition(seniorDeveloper, salary));
        } else {
            assertFalse(employeeManager.isSalaryValidForPosition(seniorDeveloper, salary));
        }
        //juniorDeveloper
        if(salary >= juniorDeveloper.getMinSalary() && salary <= juniorDeveloper.getMaxSalary()) {
            assertTrue(employeeManager.isSalaryValidForPosition(juniorDeveloper, salary));
        } else {
            assertFalse(employeeManager.isSalaryValidForPosition(juniorDeveloper, salary));
        }
    }
